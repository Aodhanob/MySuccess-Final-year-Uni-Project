...
export class WebService {
    ...
    private notes_private_list: any = [];
    private notesSubject = new Subject();
    notes_list = this.notesSubject.asObservable();
    ...
    postNote(note: any){
        ...
        return this.http.post('http://localhost:5000/api/v1.0/habits/' + this.habitID + "/notes/", postData);
    }
